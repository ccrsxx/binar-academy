 ...
 * @property {Sequelize} Sequelize
 * @property {ReturnType<typeof import('./car.js').default>} Car
 */
...
async function initializeDatabase() {
  ...
  const developmentConfig = /** @type {import('sequelize').Options} */ (
    config.development
  );
...
export const { sequelize, Car } = await initializeDatabase();
